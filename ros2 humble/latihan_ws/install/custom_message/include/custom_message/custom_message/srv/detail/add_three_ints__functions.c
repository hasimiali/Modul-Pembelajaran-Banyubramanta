...
custom_message__srv__AddThreeInts_Request__create()
{
  ...
  custom_message__srv__AddThreeInts_Request * msg = (custom_message__srv__AddThreeInts_Request *)allocator.allocate(sizeof(custom_message__srv__AddThreeInts_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_message__srv__AddThreeInts_Request));
  bool success = custom_message__srv__AddThreeInts_Request__init(msg);
  if (!success) {
...
custom_message__srv__AddThreeInts_Request__destroy(custom_message__srv__AddThreeInts_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    custom_message__srv__AddThreeInts_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
custom_message__srv__AddThreeInts_Request__Sequence__init(custom_message__srv__AddThreeInts_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__srv__AddThreeInts_Request * data = NULL;

  if (size) {
    data = (custom_message__srv__AddThreeInts_Request *)allocator.zero_allocate(size, sizeof(custom_message__srv__AddThreeInts_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_message__srv__AddThreeInts_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_message__srv__AddThreeInts_Request__fini(&data[i - 1]);
      }
...
custom_message__srv__AddThreeInts_Request__Sequence__fini(custom_message__srv__AddThreeInts_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_message__srv__AddThreeInts_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__srv__AddThreeInts_Request__Sequence * array = (custom_message__srv__AddThreeInts_Request__Sequence *)allocator.allocate(sizeof(custom_message__srv__AddThreeInts_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_message__srv__AddThreeInts_Request__Sequence__init(array, size);
  if (!success) {
...
custom_message__srv__AddThreeInts_Request__Sequence__destroy(custom_message__srv__AddThreeInts_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_message__srv__AddThreeInts_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_message__srv__AddThreeInts_Request__Sequence__are_equal(const custom_message__srv__AddThreeInts_Request__Sequence * lhs, const custom_message__srv__AddThreeInts_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_message__srv__AddThreeInts_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_message__srv__AddThreeInts_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_message__srv__AddThreeInts_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_message__srv__AddThreeInts_Request * data =
      (custom_message__srv__AddThreeInts_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_message__srv__AddThreeInts_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_message__srv__AddThreeInts_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_message__srv__AddThreeInts_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__srv__AddThreeInts_Response * msg = (custom_message__srv__AddThreeInts_Response *)allocator.allocate(sizeof(custom_message__srv__AddThreeInts_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_message__srv__AddThreeInts_Response));
  bool success = custom_message__srv__AddThreeInts_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
custom_message__srv__AddThreeInts_Response__destroy(custom_message__srv__AddThreeInts_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    custom_message__srv__AddThreeInts_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
custom_message__srv__AddThreeInts_Response__Sequence__init(custom_message__srv__AddThreeInts_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__srv__AddThreeInts_Response * data = NULL;

  if (size) {
    data = (custom_message__srv__AddThreeInts_Response *)allocator.zero_allocate(size, sizeof(custom_message__srv__AddThreeInts_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_message__srv__AddThreeInts_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        custom_message__srv__AddThreeInts_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
custom_message__srv__AddThreeInts_Response__Sequence__fini(custom_message__srv__AddThreeInts_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_message__srv__AddThreeInts_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_message__srv__AddThreeInts_Response__Sequence * array = (custom_message__srv__AddThreeInts_Response__Sequence *)allocator.allocate(sizeof(custom_message__srv__AddThreeInts_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_message__srv__AddThreeInts_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
custom_message__srv__AddThreeInts_Response__Sequence__destroy(custom_message__srv__AddThreeInts_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_message__srv__AddThreeInts_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_message__srv__AddThreeInts_Response__Sequence__are_equal(const custom_message__srv__AddThreeInts_Response__Sequence * lhs, const custom_message__srv__AddThreeInts_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_message__srv__AddThreeInts_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_message__srv__AddThreeInts_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_message__srv__AddThreeInts_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_message__srv__AddThreeInts_Response * data =
      (custom_message__srv__AddThreeInts_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_message__srv__AddThreeInts_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_message__srv__AddThreeInts_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_message__srv__AddThreeInts_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
